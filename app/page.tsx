...
export default function Home() {
  const birthdate = new Date('2007-03-02'); 
        ...
        <div className="wrapper">
          <div className="profile-card">
              <div className="profile-card-img">
                  <Image src="/me.jpg" alt="profile card" width={150} height={150}/>
              </div>
              
              <div className="profile-card-cnt">
                  <p className="profile-card-name">Gracia Michaela Patty</p>
                  <p className="profile-card-mail">graciapatty32@gmail.com</p>
                  <p className="profile-card-txt">{age} y.o | Backend Developer</p>      
              </div>

              <div className="profile-card-loc">
                  <span className="profile-card-loc-icon">
                  <svg className="icon"><use href="#icon-location"></use></svg>
                  </span>
                  <span className="profile-card-loc-txt">Jakarta, Indonesia</span>
              </div>

              <div className="profile-card-social" style={{ pointerEvents: 'auto' }}>
                  <a href="https://www.instagram.com/geraise" className="profile-card-social__item instagram" target="_blank">
                    <span className="icon-font">
                        <svg className="icon"><use href="#icon-instagram"></use></svg>
                    </span>
                  </a>

                  <a href="https://www.linkedin.com/in/gracia-patty" className="profile-card-social__item linkedin" target="_blank">
                  <span className="icon-font">
                    <svg className="icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-linkedin"></use></svg>
                  </span>
                </a>

                  <a href="https://github.com/grcias" className="profile-card-social__item github" target="_blank">
                    <span className="icon-font">
                        <svg className="icon"><use href="#icon-github"></use></svg>
                    </span>
                  </a>
          
                  <a href="https://open.spotify.com/user/aaeu4c8voi4cg48tznb98bvce?si=LlDXuo-oS6q6RmHTA_Qapg" className="profile-card-social__item spotify" target="_blank">
                    <span className="icon-font">
                        <svg className="icon" style={{color: "rgb(21, 213, 69);"}} xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16"><use href="#icon-spotify"></use></svg>
                    </span>
                  </a>
              </div>
...
<defs>   
  ...
  <symbol id="icon-spotify" viewBox="0 0 16 16">
      <title>spotify</title>
      <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zm3.669 11.538a.498.498 0 0 1-.686.165c-1.879-1.147-4.243-1.407-7.028-.77a.499.499 0 0 1-.222-.973c3.048-.696 5.662-.397 7.77.892a.5.5 0 0 1 .166.686zm.979-2.178a.624.624 0 0 1-.858.205c-2.15-1.321-5.428-1.704-7.972-.932a.625.625 0 0 1-.362-1.194c2.905-.881 6.517-.454 8.986 1.063a.624.624 0 0 1 .206.858zm.084-2.268C10.154 5.56 5.9 5.419 3.438 6.166a.748.748 0 1 1-.434-1.432c2.825-.857 7.523-.692 10.492 1.07a.747.747 0 1 1-.764 1.288z" fill="#15d545"></path> 
  </symbol>
</defs>
</svg>
